...
export function Calculator() {
  ...
  const Btn = ({
    ...
    <button
      ...
      onClick={onClick}
      className={cn(
        'h-11 rounded-md text-sm font-medium transition-colors focus-visible:outline-2 focus-visible:outline-ring',
        wide && 'col-span-2',
  ...
  return (
    <div className="w-56 rounded-xl border border-border bg-card p-3 shadow-sm">
      <div className="mb-2 h-12 overflow-hidden rounded-md bg-muted px-3 text-right font-mono text-2xl leading-[3rem] tabular-nums">
        {display}
      </div>
